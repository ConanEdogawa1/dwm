...
static const char *fonts[]          = { "Fira Code Nerd Font Mono, Microsoft YaHei:size=16:type=Regular:antialias=true:autoint=true",
                                        "Symbols Nerd Font:pixelseze=16:type=2048-em:antialas=true:autoint=true" };
